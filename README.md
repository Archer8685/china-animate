...
響應式 [破曉動漫社](https://www.youtube.com/@DawnAnimeClub)、[小七動漫社](https://www.youtube.com/@aiStory008_01) 與 [KK動漫社 Anime Club](https://www.youtube.com/@kkanimeclub) YouTube 合併熱門影片排行，支援每日、每週、每月、每季、每年、頻道篩選，以及影片名稱或頻道名稱搜尋。排行規則為「期間內上架的影片，依目前觀看數排序」。每個頻道各自保留播放清單與影片快取，只補抓新增內容。
